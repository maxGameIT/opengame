...
namespace Master
{
    public static partial class Constant
    {
        ...
        public static class Layer
        {
            ...
            public static readonly int playerObjectLayerId = LayerMask.NameToLayer(playerLayerName);

            public const string MasterLayerName = "master";
            public static readonly int MasterObjectLayerId = LayerMask.NameToLayer(MasterLayerName);
