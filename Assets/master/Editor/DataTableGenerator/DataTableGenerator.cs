...
namespace Master.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        private const string DataTablePath = "Assets/master/DataTables";
        private const string CSharpCodePath = "Assets/master/Scripts/DataTable";
        private const string CSharpCodeTemplateFileName = "Assets/master/Configs/DataTableCodeTemplate.txt";
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "Master");
        ...
        private static string GenerateDataTableStringParser(DataTableProcessor dataTableProcessor)
        {
            ...
            stringBuilder
                ...
                .AppendLine("        {")
                .AppendLine("            // Master 示例代码，正式项目使用时请调整此处的生成代码，以处理 GCAlloc 问题！")
